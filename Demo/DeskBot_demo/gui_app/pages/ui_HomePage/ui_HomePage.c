...
// btns on dropdown
static void ui_event_HomeBtn(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if(event_code == LV_EVENT_CLICKED)
    {
...
void ui_HomePage_init(void)
{
    ...
    lv_obj_set_x(ui_NoWifiLabel, 100);
    lv_obj_set_y(ui_NoWifiLabel, 10);
    ...
    if(lv_obj_get_style_pad_top(ui_LightSlider, LV_PART_MAIN) > 0) lv_obj_set_style_pad_right(ui_LightSlider,
                                                                                            lv_obj_get_style_pad_right(ui_LightSlider, LV_PART_MAIN) + 1,
                                                                                            LV_PART_MAIN);
    ...
    if(lv_obj_get_style_pad_top(ui_SoundSlider, LV_PART_MAIN) > 0) lv_obj_set_style_pad_right(ui_SoundSlider,
                                                                                            lv_obj_get_style_pad_right(ui_SoundSlider, LV_PART_MAIN) + 1,
                                                                                            LV_PART_MAIN);
    ...
    lv_obj_add_event_cb(ui_WifiBtn, ui_event_SetBtn, LV_EVENT_CLICKED, "SettingPage");
    ...
    lv_obj_add_event_cb(ui_BLEBtn, ui_event_SetBtn, LV_EVENT_CLICKED, "SettingPage");
    ...
    lv_obj_add_event_cb(ui_HomeBtn, ui_event_HomeBtn, LV_EVENT_CLICKED, "HomePage");
    ...
    lv_obj_set_x(ui_SettingBtn, 315 - 70);
    ...
    lv_obj_set_x(ui_WeatherBtn, 410 - 70);
    ...
    lv_obj_set_x(ui_CalendarBtn, 505 - 70);
    ...
    lv_obj_set_x(ui_MemoBtn, 315 - 70);
    ...
    lv_obj_set_x(ui_GameMuyuBtn, 410 - 70);
    ...
    lv_obj_set_x(ui_Game2048Btn, 505 - 70);
    ...
    lv_obj_set_x(ui_AIChatBtn, 800 + 315 - 70);
    ...
    lv_obj_set_x(ui_CameraBtn, 800 + 410 - 70);
    ...
    lv_obj_set_x(ui_YOLOBtn, 800 + 505 - 70);
    ...
    lv_obj_set_x(ui_GameMemBtn, 800 + 315 - 70);
    ...
    lv_obj_set_x(ui_DrawBtn, 800 + 410 - 70);
    ...
    lv_obj_set_x(ui_CalculatorBtn, 800 + 505 - 70);
