...
static void date_set_confirm_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_CLICKED) {
        // set system date
        sys_get_time(&ui_system_para.year, &ui_system_para.month, &ui_system_para.day, &ui_system_para.hour, &ui_system_para.minute, NULL);
        ui_system_para.year = lv_roller_get_selected(ui_RollerYear) + 2026;
...
static void adcode_set_confirm_cb(lv_event_t * e)
{
    ...
    ui_LabelLocationName = lv_obj_get_child(ui_AdcodeSetSection1, 6);
...
static void ui_CommonMenu_init(void)
{
    ...
    lv_obj_set_width(ui_PanelCommonMenu, 400);
    lv_obj_set_height(ui_PanelCommonMenu, 240);
    ...
    lv_obj_set_width(ui_CommonSection1, 380);
    lv_obj_set_height(ui_CommonSection1, 160);
    ...
    lv_obj_set_y(ui_LabelBright, -45);
    ...
    if(lv_slider_get_mode(ui_BrightSlider) == LV_SLIDER_MODE_RANGE) lv_slider_set_left_value(ui_BrightSlider, 0, LV_ANIM_OFF);
    lv_obj_set_width(ui_BrightSlider, 300);
    ...
    if(lv_obj_get_style_pad_top(ui_BrightSlider, LV_PART_MAIN) > 0) lv_obj_set_style_pad_right(ui_BrightSlider, lv_obj_get_style_pad_right(ui_BrightSlider, LV_PART_MAIN) + 1, LV_PART_MAIN);
    ...
    lv_obj_set_width(ui_SoundSlider, 300);
    ...
    //Compensating for LVGL9.1 draw crash with bar/slider max value when top-padding is nonzero and right-padding is 0
    if(lv_obj_get_style_pad_top(ui_SoundSlider, LV_PART_MAIN) > 0) lv_obj_set_style_pad_right(ui_SoundSlider, lv_obj_get_style_pad_right(ui_SoundSlider, LV_PART_MAIN) + 1, LV_PART_MAIN);
...
static void ui_TimeDateMenu_init(void)
{
    ...
    lv_obj_set_width(ui_PanelTimeDateMenu, 400);
    lv_obj_set_height(ui_PanelTimeDateMenu, 240);
    ...
    lv_obj_set_width(ui_TimeDateSection1, 400);
    lv_obj_set_height(ui_TimeDateSection1, 50);
    lv_obj_set_style_pad_top(ui_TimeDateSection1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_IconAutoTime, 0);
    lv_obj_set_y(ui_IconAutoTime, 10);
    ...
    lv_obj_set_y(ui_LabelAutoTime, 10);
    ...
    lv_obj_set_x(ui_SwitchAutoTime, -20);
    lv_obj_set_y(ui_SwitchAutoTime, 10);
    ...
    lv_obj_set_width(ui_TimeDateSection2, 400);
    lv_obj_set_height(ui_TimeDateSection2, 100);
    lv_obj_set_x(ui_TimeDateSection2, 0);
    lv_obj_set_y(ui_TimeDateSection2, 60);
    lv_obj_set_style_pad_top(ui_TimeDateSection2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_PanelTimeSet, 400);
    lv_obj_set_height(ui_PanelTimeSet, 40);
    lv_obj_set_x(ui_PanelTimeSet, 0);
    lv_obj_set_y(ui_PanelTimeSet, 10);
    ...
    lv_obj_set_width(ui_PanelDateSet, 400);
    lv_obj_set_height(ui_PanelDateSet, 40);
    lv_obj_set_x(ui_PanelDateSet, 0);
    lv_obj_set_y(ui_PanelDateSet, 50);
...
static void ui_LocationMenu_init(void)
{
    ...
    lv_obj_set_width(ui_PanelLocationMenu, 400);
    lv_obj_set_height(ui_PanelLocationMenu, 240);
    ...
    lv_obj_set_width(ui_LocationSection1, 400);
    lv_obj_set_height(ui_LocationSection1, 50);
    lv_obj_set_x(ui_LocationSection1, 0);
    lv_obj_set_y(ui_LocationSection1, -15);
    ...
    lv_obj_set_width(ui_LocationSection2, 400);
    lv_obj_set_height(ui_LocationSection2, 50);
    lv_obj_set_style_pad_top(ui_LocationSection2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_x(ui_LocationSection2, 0);
    lv_obj_set_y(ui_LocationSection2, 45);
    ...
    lv_obj_set_width(ui_PanelADCodeSet, 400);
    lv_obj_set_height(ui_PanelADCodeSet, 40);
    lv_obj_set_x(ui_PanelADCodeSet, 0);
    lv_obj_set_y(ui_PanelADCodeSet, 2);
...
static void ui_AboutMenu_init(void)
{
    ...
    lv_obj_set_width(ui_PanelAboutMenu, 400);
    lv_obj_set_height(ui_PanelAboutMenu, 240);
    ...
    lv_obj_set_width(ui_TimeAboutSection1, 400);
    lv_obj_set_height(ui_TimeAboutSection1, 100);
    lv_obj_set_x(ui_TimeAboutSection1, 0);
    lv_obj_set_y(ui_TimeAboutSection1, -15);
    ...
    lv_obj_set_width(ui_PanelSoftwareInfo, 400);
    ...
    lv_obj_set_width(ui_PanelLegalInfo, 400);
    lv_obj_set_height(ui_PanelLegalInfo, 40);
    lv_obj_set_x(ui_PanelLegalInfo, 0);
    lv_obj_set_y(ui_PanelLegalInfo, 30);
...
static void ui_TimeSetMenu_init(void)
{
    ...
    lv_obj_set_width(ui_PanelTimeSetMenu, 400);
    lv_obj_set_height(ui_PanelTimeSetMenu, 240);
    ...
    lv_obj_set_y(ui_TimeSetSection1, -15);
    ...
    lv_obj_set_x(ui_BtnTimeSetConfirme, 0);
...
static void ui_DateSetMenu_init(void)
{
    ...
    lv_obj_set_width(ui_PanelDateMenu, 400);
    lv_obj_set_height(ui_PanelDateMenu, 240);
    ...
    lv_obj_set_y(ui_DateSetSection1, -15);
    ...
    // set roller value
    lv_roller_set_selected(ui_RollerYear, ui_system_para.year - 2026, LV_ANIM_OFF);
    ...
    lv_obj_set_x(ui_BtnDateSetConfirme, 0);
    lv_obj_set_y(ui_BtnDateSetConfirme, -20);
...
static void ui_AdcodeSetMenu_init(void)
{
    ...
    lv_obj_set_width(ui_PanelAdcodeSetMenu, 400);
    lv_obj_set_height(ui_PanelAdcodeSetMenu, 240);
    ...
    lv_obj_set_width(ui_AdcodeSetSection1, 365);
    lv_obj_set_height(ui_AdcodeSetSection1, 130);
    lv_obj_set_x(ui_AdcodeSetSection1, 0);
    lv_obj_set_y(ui_AdcodeSetSection1, -15);
    ...
    lv_obj_set_width(ui_RollerAdcode1, 50);
    lv_obj_set_height(ui_RollerAdcode1, 110);
    lv_obj_set_x(ui_RollerAdcode1, -15);
    ...
    lv_obj_set_width(ui_RollerAdcode2, 50);
    lv_obj_set_height(ui_RollerAdcode2, 110);
    lv_obj_set_x(ui_RollerAdcode2, 45);
    ...
    lv_obj_set_width(ui_RollerAdcode3, 50);
    lv_obj_set_height(ui_RollerAdcode3, 110);
    lv_obj_set_x(ui_RollerAdcode3, 105);
    ...
    lv_obj_set_width(ui_RollerAdcode4, 50);
    lv_obj_set_height(ui_RollerAdcode4, 110);
    lv_obj_set_x(ui_RollerAdcode4, 165);
    ...
    lv_obj_set_width(ui_RollerAdcode5, 50);
    lv_obj_set_height(ui_RollerAdcode5, 110);
    lv_obj_set_x(ui_RollerAdcode5, 225);
    ...
    lv_obj_set_width(ui_RollerAdcode6, 50);
    lv_obj_set_height(ui_RollerAdcode6, 110);
    lv_obj_set_x(ui_RollerAdcode6, 285);
    ...
    lv_obj_set_x(ui_BtnAdcodeSetConfirme, 0);
    lv_obj_set_y(ui_BtnAdcodeSetConfirme, -20);
...
void ui_SettingPage_init()
{
    ...
    lv_obj_set_width(ui_PanelMainMenu, 400);
    lv_obj_set_height(ui_PanelMainMenu, 240);
    ...
    lv_obj_set_height(ui_PanelMenuSection1, 140);
    lv_obj_set_style_pad_top(ui_PanelMenuSection1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_x(ui_PanelMenuSection1, 0);
    lv_obj_set_y(ui_PanelMenuSection1, -15);
    ...
    lv_obj_set_y(ui_PanelCommon, 10);
    ...
    lv_obj_set_y(ui_PanelLocation, 90);
    ...
    lv_obj_set_x(ui_LabelSection2, -115);
    ...
    lv_obj_set_height(ui_PanelMenuSection2, 100);
    lv_obj_set_style_pad_top(ui_PanelMenuSection2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_x(ui_PanelMenuSection2, 0);
    lv_obj_set_y(ui_PanelMenuSection2, 160);
    ...
    lv_obj_set_y(ui_PanelMenuMode, 50);
